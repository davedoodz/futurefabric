...
export default function App() {
  ...
  const layout = useDialKit(
    "Layout",
    {
      ...
      productCompanySize: [16, 8, 40, 1],
      productCompanyColor: "#000000",
      productTitleSubtitleGap: [4, 0, 80, 1],
      wordmarkGap: [11, 0, 80, 1],
      titleSubtitleGap: [10, 0, 80, 1],
      subtitlePillsGap: [51, 0, 120, 1],
      pillsGalleryGap: [25, 0, 200, 1],
      elementSpacing: [4, 0, 32, 1],
      matrixGapX: [96, 0, 96, 1],
      matrixGapY: [37, 0, 128, 1],
      frameWidth: [420, 120, 420, 1],
      frameHeight: [335, 120, 420, 1],
    },
